/* WaslPay 2.3.4 — household message context plus current release note; no payment logic changes. */
'use strict';
const WaslHouseholdMessage234=(()=>{
 const RELEASE='2.3.4';
 ...
 function stamp(root){
  ...
  const badge=body.querySelector('.community-badge');if(badge)badge.textContent='2.3.4 · الاثنين 21 سبتمبر 2026';
  if(!body.querySelector('[data-release-234]')){
   const p=root.createElement?root.createElement('p'):document.createElement('p');p.dataset.release234='1';
   p.textContent='إصلاح اليوم: صححنا تبويب تثبيت iPhone وiPad ونص تنبيه الرسائل وأغلقنا زر طلبات الأسرة بصورة سليمة، مع إبقاء منطق الأموال وبيانات الأسرة دون تغيير.';
...
if(typeof module!=='undefined'&&module.exports)module.exports=WaslHouseholdMessage234;
if(typeof document!=='undefined'){
 const run=()=>WaslHouseholdMessage234.enhance();
